...
def test_tuple_with_one_element():
    test1 = (1)
    assert int == type(test1)

    test2 = (1,)  #note the syntax used to disambiguate
    assert tuple == type(test2)
...
- tuples are another sequenced type ds .
- elements are indexed and can be sliced
- different methods supported by tuple
"""
