...
- different types of ways of defining strings in python(single,double,triple quoted)
- Strings are indexed and can be sliced according to our requirement
- it supports formatting and includes membership testing
"""