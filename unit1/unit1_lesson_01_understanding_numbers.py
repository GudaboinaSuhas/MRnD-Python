...
def test_numbers_types():
    assert int == type(7)
    assert  float == type(7.5)
    assert long == type(10L)
...
- converting integers of different number system to decimal
- types of arithmetic operations which can performed in console easily
- converting numbers of different bases to string
"""
