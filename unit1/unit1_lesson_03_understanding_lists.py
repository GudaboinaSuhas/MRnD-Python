...
def test_list_slice_replacement_is_inplace():
    ...
    fruits[:2] = ['guava','apple']
    assert ['guava', 'apple', 'guava', 'apple'] == fruits
...
- lists preserves order of insertion of elements
- elements are indexed and can be sliced
- different methods supported by list
"""